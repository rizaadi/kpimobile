...
import '../../../core/widgets/list_single_container.dart';
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          PopupMenuButton(
                              ...
                              itemBuilder: (context) => [
                                    customPopupMenuItem('History', 'assets/icons/history.svg', Get.theme.primaryColor,
                                        Options.History.index),
                                    customPopupMenuItem('Delete', 'assets/icons/trash-2.svg', Get.theme.errorColor,
                      ...
                      ListContainer(title: "Badge", value: kpi?['badge'] ?? "Kosong", color: Colors.white),
                      ListContainer(
                          title: "Jabatan", value: kpi?['jabatan'] ?? "Kosong", color: ThemeConfig.colors.Gray_primary),
                      ListContainer(title: "Unit Kerja", value: kpi?['unitKerja'] ?? "Kosong", color: Colors.white),
                      ListThreeContainer(
                          name1: kpi?['atasan1'] ?? "Kosong",
                          name2: kpi?['atasan2'] ?? "Kosong",
                          name3: kpi?['atasan3'] ?? "Kosong",
                          color: ThemeConfig.colors.Gray_primary),
                      ListContainer(title: "Status", value: kpi?['status'][0] ?? "Kosong", color: Colors.white),
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Visibility(
                                visible: ((controller.role == 'Atasan' &&
                                    ...
                                    ((controller.role == 'Karyawan' && kpi?['status'][0] == 'Draft')),
                                child: ElevatedButton.icon(
                                    onPressed: () {
                                      Get.toNamed(Routes.TAMBAH_KPI, arguments: idKpi);
                                    },
                                    icon: SvgPicture.asset('assets/icons/plus.svg', width: 18, height: 18),
                          ...
                          Visibility(
                            ...
                            child: Obx(() => ElevatedButton.icon(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      onTap: () {
                                                        controller.tolakKpi(idKpi);
                                                      },
                                                      child: ChipApproveKpi(
                                                        name: "Tolak",
                                                        asset: 'assets/icons/x-circle.svg',
                                                        color: ThemeConfig.colors.Red_primary,
                                                      ),
                                                    ),
                                                  ],
                                                ),
                                ...
                                label: Text(controller.role == 'Atasan' ? 'Approve KPI' : "Submit KPI"))),
                          ),
                        ],
                      ),
                      const SizedBox(height: 11),
                      ...
                      SizedBox(
                        ...
                        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                            ...
                            builder: (context, snapshotlist) {
                              ...
                              if (snapshotlist.connectionState == ConnectionState.waiting) {
                              ...
                              } else if (snapshotlist.data?.docs.length == 0 || snapshotlist.data?.docs == null) {
                                return const Padding(
                                  padding: EdgeInsets.only(top: 20),
                                  child: Align(alignment: Alignment.topCenter, child: Text("KPI belum diisi")),
                                );
                                ...
                                if (controller.role == "Atasan") {
                                  return DataTable2(
                                    ...
                                    bottomMargin: 16,
                                    headingTextStyle:
                                        TextStyle(fontWeight: FontWeight.w600, color: ThemeConfig.colors.Black_primary),
                                    dividerThickness: 0,
                                    columns: const [
                                      DataColumn2(
                                        fixedWidth: 30,
                                      ...
                                      DataColumn2(fixedWidth: 90, label: Text("Target")),
                                      DataColumn2(
                                        fixedWidth: 120,
